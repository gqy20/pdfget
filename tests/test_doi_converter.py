...
class TestDOIConverter:
    ...
    def test_doi_to_pmcid_success_europepmc(
        self, converter, session, doi, expected_pmcid
    ):
        """
        ...
        def mock_get(url, **kwargs):
            ...
            if 'doi:"10.1186/s12916-020-01690-4"' in query:
                mock_response.json.return_value = {
                    "resultList": {
                        "result": [
                            {"pmcid": "PMC7439635", "doi": "10.1186/s12916-020-01690-4"}
                        ]
                    }
                }
                ...
                mock_response.json.return_value = {
                    "resultList": {
                        "result": [
                            {"pmcid": "PMC7180979", "doi": "10.1016/j.cell.2020.01.021"}
                        ]
                    }
                }
            else:
    ...
    def test_doi_to_pmcid_caching(self, converter, session):
        ...
        mock_response.json.return_value = {
            "resultList": {
                "result": [{"pmcid": "PMC123456789", "doi": "10.1000/test.doi"}]
            }
        }
        session.get.return_value = mock_response
    ...
    def test_doi_converter_configuration(self, converter):
        ...
        assert (
            converter.europepmc_doi_url == "https://www.ebi.ac.uk/europepmc/api/search"
        )
